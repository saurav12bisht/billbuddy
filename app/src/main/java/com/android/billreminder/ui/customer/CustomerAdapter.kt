...
import com.android.billreminder.databinding.ItemCustomerBinding
...
class CustomerAdapter(
    ...
    class VH(
        ...
        fun bind(item: CustomerWithBalance) {
            ...
            b.tvPhone.text = com.android.billreminder.ui.common.util.DateFormatter.formatPhone(item.phone)
            b.tvBalance.text = CurrencyFormatter.formatPaiseToRupee(item.balance)
            b.tvBalance.setTextColor(
                b.root.context.getColor(
                    when {
                        item.balance > 0 -> com.android.billreminder.R.color.accent_red
                        item.balance < 0 -> com.android.billreminder.R.color.paid_success
                        else -> com.android.billreminder.R.color.text_secondary
                    }
                )
            )
