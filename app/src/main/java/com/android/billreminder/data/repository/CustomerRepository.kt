...
import com.android.billreminder.data.local.entity.CustomerEntity
...
class CustomerRepository @Inject constructor(
    ...
    fun getAllActiveCustomers(): Flow<List<com.android.billreminder.data.local.entity.CustomerEntity>> =
