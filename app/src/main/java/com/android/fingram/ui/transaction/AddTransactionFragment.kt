package com.android.fingram.ui.transaction
...
import com.android.fingram.databinding.FragmentAddTransactionBinding
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.uiState.collectLatest { state ->
                    when (state) {
                        is com.android.fingram.ui.customer.UiState.Success -> {
                        ...
                        is com.android.fingram.ui.customer.UiState.Error -> Toast.makeText(requireContext(), state.msg, Toast.LENGTH_SHORT).show()
                        else -> {}
                    }
                }
            }
