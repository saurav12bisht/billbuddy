...
import com.android.fingram.databinding.ItemCreditCardBillBinding
    ...
    inner class BillViewHolder(
        ...
        fun bind(bill: CreditCardBill) {
            ...
            if (bill.isPaid) {
                ...
                binding.tvStatusBadge.setTextColor(binding.root.context.getColor(com.android.fingram.R.color.paid_success))
                ...
                binding.tvStatusBadge.setTextColor(
                    binding.root.context.getColor(com.android.fingram.R.color.error_red)
                )
