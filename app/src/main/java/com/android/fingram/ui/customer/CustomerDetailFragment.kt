...
import com.android.fingram.databinding.FragmentCustomerDetailBinding
...
class CustomerDetailFragment : BaseFragment<FragmentCustomerDetailBinding>(FragmentCustomerDetailBinding::inflate) {
    ...
    private val transactionViewModel: com.android.fingram.ui.transaction.TransactionViewModel by viewModels()
...
//        binding.fab.setOnClickListener { findNavController().navigate(R.id.addTransactionFragment, Bundle().apply { putInt("customerId", customerId) }) }
        ...
        val adapter = com.android.fingram.ui.transaction.TransactionAdapter { tx ->
...
//                    )
    ...
    private fun showTransactionOptions(tx: com.android.fingram.data.local.entity.TransactionEntity) {
