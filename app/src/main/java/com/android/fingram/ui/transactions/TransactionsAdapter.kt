...
import com.android.fingram.databinding.ItemDayHeaderBinding
import com.android.fingram.databinding.ItemTransactionBinding
    ...
    class RowViewHolder(
        ...
        fun bind(
            ...
            val paymentModeLabel = when {
                ...
                item.account.accountType == com.android.fingram.data.local.entity.AccountType.CASH -> "CASH"
                item.account.accountType == com.android.fingram.data.local.entity.AccountType.BANK -> "Bank Account"
