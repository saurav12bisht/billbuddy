package com.android.fingram.ui.home
...
import com.android.fingram.databinding.FragmentHomeBinding
...
//        binding.fab.setOnClickListener { findNavController().navigate(R.id.action_home_to_add_customer) }
    ...
    private fun setupRecentList() {
        recentAdapter = RecentTransactionAdapter(
            onClick = { customerId -> findNavController().navigate(com.android.fingram.R.id.splashFragment, android.os.Bundle().apply { putInt("customerId", customerId) }) }
        )
