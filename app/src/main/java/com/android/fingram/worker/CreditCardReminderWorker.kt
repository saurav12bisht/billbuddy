...
class CreditCardReminderWorker @AssistedInject constructor(
    ...
    private val fingramDatabase: com.android.fingram.data.local.FingramDatabase
    ...
    private suspend fun maybeSendNotification(
        ...
        if (existing == null) {
            ...
            logDao.insertLog(com.android.fingram.data.local.entity.NotificationLogEntity(
                billId = billId,
