...
import com.mobile.fingram.databinding.ItemCreditCardBillBinding
    ...
    inner class BillViewHolder(
        ...
        fun bind(bill: CreditCardBill) {
            ...
            if (bill.isPaid) {
                ...
                binding.tvStatusBadge.setTextColor(binding.root.context.getColor(com.mobile.fingram.R.color.paid_success))
                ...
                binding.tvStatusBadge.setTextColor(
                    binding.root.context.getColor(com.mobile.fingram.R.color.error_red)
                )
