package com.mobile.fingram.ui.transactionform
...
class AddTransactionViewModel @Inject constructor(
    ...
    val bankAccounts: StateFlow<List<AccountEntity>> = repository.getAccountsByType(com.mobile.fingram.data.local.entity.AccountType.BANK.name)
    ...
    fun loadTransaction(id: Long) {
        viewModelScope.launch {
            ...
            _amount.value = com.mobile.fingram.ui.common.util.CurrencyFormatter.formatPaiseToRupeeWithoutSymbol(expense.amountCents)
            ...
            if (isCredit) {
                ...
                } else if (account?.accountType == com.mobile.fingram.data.local.entity.AccountType.BANK) {
