package com.mobile.fingram.ui.transaction
...
import com.mobile.fingram.databinding.FragmentAddTransactionBinding
import com.mobile.fingram.domain.model.Transaction
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.uiState.collectLatest { state ->
                    when (state) {
                        is com.mobile.fingram.ui.customer.UiState.Success -> {
                        ...
                        is com.mobile.fingram.ui.customer.UiState.Error -> Toast.makeText(requireContext(), state.msg, Toast.LENGTH_SHORT).show()
                        else -> {}
                    }
                }
            }
