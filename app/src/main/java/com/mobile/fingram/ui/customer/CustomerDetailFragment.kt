package com.mobile.fingram.ui.customer
...
import com.mobile.fingram.databinding.FragmentCustomerDetailBinding
...
class CustomerDetailFragment : BaseFragment<FragmentCustomerDetailBinding>(FragmentCustomerDetailBinding::inflate) {
    ...
    private val transactionViewModel: com.mobile.fingram.ui.transaction.TransactionViewModel by viewModels()
...
//        binding.fab.setOnClickListener { findNavController().navigate(R.id.addTransactionFragment, Bundle().apply { putInt("customerId", customerId) }) }
        ...
        val adapter = com.mobile.fingram.ui.transaction.TransactionAdapter { tx ->
...
//                    )
    ...
    private fun showTransactionOptions(tx: com.mobile.fingram.data.local.entity.TransactionEntity) {
