...
class CreditCardDetailFragment : BaseFragment<FragmentCreditCardDetailBinding>(
    ...
    private lateinit var spendsAdapter: com.mobile.fingram.ui.transactions.TransactionsAdapter
    ...
    override fun onInit() {
        ...
        spendsAdapter = com.mobile.fingram.ui.transactions.TransactionsAdapter(
            onRowClick = {},
            ...
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.uiState.collect { state ->
                    ...
                    val spendItems = state.recentSpends.map { expenseWithCategory ->
                        com.mobile.fingram.ui.transactions.TransactionListItem.TransactionRow(expenseWithCategory)
                    }
