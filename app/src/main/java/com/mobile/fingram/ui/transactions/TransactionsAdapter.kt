...
import com.mobile.fingram.databinding.ItemDayHeaderBinding
    ...
    class RowViewHolder(
        ...
        fun bind(
            ...
            val paymentModeLabel = when {
                ...
                item.account.accountType == com.mobile.fingram.data.local.entity.AccountType.CASH -> "CASH"
                item.account.accountType == com.mobile.fingram.data.local.entity.AccountType.BANK -> "Bank Account"
